...
# QPP-Evaluator
Download the `qpp-eval-main.zip' and it uses Apache lucene for the retrieval process (Download the `lucene-msmarco-main.zip' and set up the Lucene by configuring accordingly).[link]
